...
public class Main {
    public static void main(String[] args) {
        ...
        Transmission manualTransmission = new Transmission("Manual", 6);
        Tire trailTire = new Tire("Trail", 309, 70, 20);
        Wheel truckWheel = new Wheel(8, 18);
        Truck truckHino = new Truck(dieselEngine, manualTransmission, trailTire, truckWheel, 4500);
        ...
        System.out.println("Tipe transmisi: "+ truckHino.getTransmission().getTransType());
